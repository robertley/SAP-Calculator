...
export const summonPet = (
    ...
    if (summoner && hasSilly(summoner)) {
        ...
        const result = summonPet(targetTeam, spawnPet, randomPosition, fly, undefined, logService, abilityService, gameService);
...
export const summonPetInFront = (
    ...
    if (hasSpaceInFront) {
        return summonPet(player, summonedPet, summoner.position - 1, false, summoner, logService, abilityService, gameService);
    }
    ...
    return summonPet(player, summonedPet, oldPosition, false, summoner, logService, abilityService, gameService);
};
