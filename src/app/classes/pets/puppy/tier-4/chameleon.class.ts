...
import { TennisBallAbility } from 'app/classes/toys/tier-1/tennis-ball.class';
import { BalloonAbility } from 'app/classes/toys/tier-1/balloon.class';
import { PlasticSawAbility } from 'app/classes/toys/tier-2/plastic-saw.class';
import { RadioAbility } from 'app/classes/toys/tier-2/radio.class';
import { OvenMittsAbility } from 'app/classes/toys/tier-3/oven-mitts.class';
import { ToiletPaperAbility } from 'app/classes/toys/tier-3/toilet-paper.class';
import { FoamSwordAbility } from 'app/classes/toys/tier-4/foam-sword.class';
import { ToyGunAbility } from 'app/classes/toys/tier-4/toy-gun.class';
import { MelonHelmetAbility } from 'app/classes/toys/tier-4/melon-helmet.class';
import { StinkySockAbility } from 'app/classes/toys/tier-5/stinky-sock.class';
import { FlashlightAbility } from 'app/classes/toys/tier-5/flashlight.class';
import { PeanutJarAbility } from 'app/classes/toys/tier-6/peanut-jar.class';
import { AirPalmTreeAbility } from 'app/classes/toys/tier-6/air-palm-tree.class';
import { TelevisionAbility } from 'app/classes/toys/tier-6/television.class';
import { CrystalBallAbility } from 'app/classes/toys/tier-1/crystal-ball.class';
import { EvilBookAbility } from 'app/classes/toys/tier-5/evil-book.class';
import { TreasureChestAbility } from 'app/classes/toys/tier-3/treasure-chest.class';
import { WitchBroomAbility } from 'app/classes/toys/tier-1/witch-broom.class';
import { TreasureMapAbility } from 'app/classes/toys/tier-3/treasure-map.class';
import { PandorasBoxAbility } from 'app/classes/toys/tier-5/pandoras-box.class';
import { StickAbility } from 'app/classes/toys/tier-1/stick.class';
import { CashRegisterAbility } from 'app/classes/toys/tier-4/cash-register.class';
import { MicrowaveOvenAbility } from 'app/classes/toys/tier-2/microwave-oven.class';
import { CameraAbility } from 'app/classes/toys/tier-5/camera.class';
