...
export class SmallerSlugAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        let slug = new SmallestSlug(this.logService, this.abilityService, owner.parent, null, null, 0, owner.minExpForLevel);
    ...
    copy(newOwner: Pet): SmallerSlugAbility {
        return new SmallerSlugAbility(newOwner, this.logService, this.abilityService);
    }
}