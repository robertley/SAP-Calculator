...
export class HydraAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        for (let i = 0; i < amt; i++) {
            ...
            let head = new Head(this.logService, this.abilityService, owner.parent, power, power);

            let summonResult = owner.parent.summonPet(head, owner.savedPosition, false, owner);
