...
export class JerseyDevilAbility extends Ability {
    ...
    private pendingBuffs: Map<Pet, { attack: number; health: number }> = new Map();
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        this.pendingBuffs.set(target, { attack: existing.attack + power, health: existing.health + power });
