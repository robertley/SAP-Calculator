...
export class TaitaShrewAbility extends Ability {
    ...
    private executeAbility(gameApi: GameAPI, triggerPet?: Pet, tiger?: boolean, pteranodon?: boolean): void {
        ...
        let weasel = new Weasel(this.logService, this.abilityService, owner.parent, target.health, target.attack, target.mana, target.exp, target.equipment);
    ...
    copy(newOwner: Pet): TaitaShrewAbility {
        return new TaitaShrewAbility(newOwner, this.logService, this.abilityService);
    }
}