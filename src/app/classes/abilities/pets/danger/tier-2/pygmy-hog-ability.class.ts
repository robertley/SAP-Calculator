...
export class PygmyHogAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        let power: Power = {health: Math.max(this.level * 5, owner.health), attack: Math.max(this.level * 5, owner.attack)}; 
        let angryPygmyHog = new AngryPygmyHog(this.logService, this.abilityService, owner.parent, power.health, power.attack, owner.mana, owner.exp, new Garlic());
