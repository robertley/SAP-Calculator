...
export class CricketAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        let zombie = new ZombieCricket(this.logService, this.abilityService, owner.parent, null, null, null, exp);

        let summonResult = owner.parent.summonPet(zombie, owner.savedPosition, false, owner);
