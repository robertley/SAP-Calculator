...
export class KappaAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        let petPool = owner.parent == gameApi.player ? gameApi.playerPetPool : gameApi.opponentPetPool;
        ...
        for (let i = 0; i < owner.level; i++) {
            ...
            let summonResult = owner.parent.summonPet(spawn, owner.savedPosition, false, owner);
            ...
            let opponentSummonResult = owner.parent.opponent.summonPet(opponentSpawnPet, owner.savedPosition, false, owner);
    ...
    copy(newOwner: Pet): KappaAbility {
        return new KappaAbility(newOwner, this.logService, this.abilityService, this.petService);
    }
}