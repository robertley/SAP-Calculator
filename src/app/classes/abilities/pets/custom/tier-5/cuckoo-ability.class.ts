...
export class CuckooAbility extends Ability {
    constructor(owner: Pet, private logService: LogService, private abilityService: AbilityService) {
        super({
            name: 'CuckooAbility',
            owner: owner,
            triggers: ['EnemyFaint'],
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        let cuckooChick = new CuckooChick(this.logService, this.abilityService, opponent);
