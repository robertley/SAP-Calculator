...
import { canApplyAilment, getAdjacentAlivePets, logAbility } from "../../../ability-helpers";
...
export class PeacockSpiderAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        for (const target of targets) {
            ...
            logAbility(this.logService, owner, `${owner.name} gave ${target.name} Spooked.`, tiger, pteranodon);
        }
