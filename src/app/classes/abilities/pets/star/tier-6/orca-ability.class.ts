...
export class OrcaAbility extends Ability {
    ...
    private executeAbility(context: AbilityContext): void {
        ...
        for (let i = 0; i < this.level; i++) {
            ...
            let summonResult = owner.parent.summonPet(faintPet, owner.savedPosition, false, owner);
    ...
    copy(newOwner: Pet): OrcaAbility {
        return new OrcaAbility(newOwner, this.logService, this.abilityService, this.petService);
    }
}
