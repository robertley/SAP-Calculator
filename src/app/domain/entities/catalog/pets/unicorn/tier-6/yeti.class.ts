...
export class YetiAbility extends Ability {
  ...
  copy(newOwner: Pet): YetiAbility {
    return new YetiAbility(newOwner, this.logService, this.abilityService);
  }
}
