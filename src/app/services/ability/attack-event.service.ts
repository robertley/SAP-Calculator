    ...
    triggerBeforeAttackEvents(attackingPet: Pet) {
        ...
        for (let pet of friends) {
            if (pet.hasTrigger('BeforeFriendlyAttack')) {
                this.abilityQueueService.triggerAbility(pet, 'BeforeFriendlyAttack', undefined, undefined);
            ...
            if (pet == attackingPet.petAhead || pet == attackingPet.petBehind()) {
                if (pet.hasTrigger('BeforeAdjacentFriendAttacked')) {
                    ...
                    this.abilityQueueService.triggerAbility(pet, 'BeforeAdjacentFriendAttacked');
                }
            }
        }
    }
    ...
    triggerAfterAttackEvents(attackingPet: Pet) {
        ...
        for (let pet of team) {
            ...
            this.abilityQueueService.handleNumberedCounterTriggers(
                ...
                undefined,
                undefined,
                this.abilityQueueService.getNumberedTriggersForPet(pet, 'FriendlyAttacked')
            );
            ...
            if (pet.hasTrigger('AnyoneAttack')) {
                this.abilityQueueService.triggerAbility(pet, 'AnyoneAttack', attackingPet);
            }
            ...
            if (pet == attackingPet) {
                ...
                if (pet.hasTrigger('FriendAttacked')) { // "FriendAttacked" = Friend Attacked (Active voice)
                ...
                this.abilityQueueService.handleNumberedCounterTriggers(
                    ...
                    undefined,
                    undefined,
                    this.abilityQueueService.getNumberedTriggersForPet(pet, 'FriendAttacked')
                );
            }

            if (pet == attackingPet.petAhead || pet == attackingPet.petBehind()) {
                if (pet.hasTrigger('AdjacentFriendAttacked')) {
                    this.abilityQueueService.triggerAbility(pet, 'AdjacentFriendAttacked', attackingPet);
                }
            }
        ...
        const opponentTeam = this.abilityQueueService.getTeam(attackingPet.parent?.opponent);
        ...
        for (let pet of opponentTeam) {
            ...
            if (pet.hasTrigger('EnemyAttacked')) { // "EnemyAttacked" = Enemy [has] Attacked
            ...
            this.abilityQueueService.handleNumberedCounterTriggers(
                ...
                undefined,
                undefined,
                this.abilityQueueService.getNumberedTriggersForPet(pet, 'EnemyAttacked')
            );
        }
    }
}
