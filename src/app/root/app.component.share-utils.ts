...
export function buildApiResponse(playerWins: number, opponentWins: number, draws: number): string {
...
export function buildShareableLink(formGroup: FormGroup, baseUrl: string): string {
